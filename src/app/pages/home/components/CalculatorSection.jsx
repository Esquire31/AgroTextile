      ...
      <div className="bg-card-header rounded-xl p-6 md:p-12 lg:p-20 grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center shadow-lg border border-primary">
        <div>
          <h2 className="text-2xl text-text-primary sm:text-3xl md:text-[48px] leading-tight md:leading-14 font-headline-lg mb-4 md:mb-8 font-bold">
            Estimate Your <span className="text-primary italic">Scale</span>
          </h2>
          ...
          <div className="space-y-8 md:space-y-12">
            <div>
              <div className="flex justify-between mb-4 md:mb-6 flex-wrap gap-2">
                <span className="font-bold font-label-sm text-text-primary uppercase tracking-widest opacity-60 text-xs sm:text-sm">Container Size</span>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6">
              <div className="bg-card-secondary p-4 md:p-6 rounded-xl border border-outline-variant/30 flex flex-col gap-1">
                <div className="text-xs text-text-primary opacity-50 uppercase font-label-sm tracking-widest">Payload (Max)</div>
                <div className="text-lg text-text-primary md:text-2xl font-bold tabular-nums">{containerData[sliderValue].payload}</div>
              </div>
              <div className="bg-card-secondary p-4 md:p-6 rounded-xl border border-outline-variant/30 flex flex-col gap-1">
                <div className="text-xs text-text-primary opacity-50 uppercase font-label-sm tracking-widest">Capacity</div>
