...
export default function CommandCenterSection() {
  return (
    <section className="py-12 md:py-24 relative overflow-hidden bg-card-secondary">
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-8 md:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 tabular-nums">
              <div className="flex justify-between items-center py-4 px-6 bg-card-secondary rounded-xl border border-outline-variant/10">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <div className="font-bold text-text-primary font-body-md">ATX-9921-LON</div>
                    <div className="text-xs text-text-primary opacity-60 font-body-md">Textiles | Mumbai to London</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-bold text-text-primary font-body-md">In Transit</div>
                  <div className="text-[10px] uppercase text-text-highlight font-label-sm">ETA: 4 Days</div>
                </div>
              </div>
              <div className="flex justify-between items-center py-4 px-6 bg-card-secondary rounded-xl border border-outline-variant/10">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <div className="font-bold text-text-primary font-body-md">ATX-1102-NYC</div>
                    <div className="text-xs text-text-primary opacity-60 font-body-md">Agro | Ahmedabad to New York</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-bold text-text-primary font-body-md">Customs Clearance</div>
                  <div className="text-[10px] uppercase text-text-highlight font-label-sm">Arrived</div>
                </div>
              </div>
            </div>
          </div>
          <div className="glass-card rounded-xl p-10 flex flex-col justify-center items-center text-center border border-outline-variant/30 shadow-lg">
            ...
            <h4 className="text-[24px] leading-8 font-title-md mb-4 font-bold text-text-primary">Enterprise Access</h4>
            <p className="text-text-primary text-sm mb-10 font-body-md leading-relaxed">
              Login to track shipments, download QC certificates, and manage orders.
            </p>
            <button className="w-full py-4 bg-primary text-text-on-primary rounded-full font-bold spring-hover spring-active font-label-sm shadow-lg shadow-[#006241]/30">
              OPEN ERP DASHBOARD
            </button>
          </div>
        </div>
